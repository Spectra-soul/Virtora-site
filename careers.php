    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            ...
            <li class="nav-item mx-3"><a href="index" >Home<br></a></li>
                    ...
                    <li class="nav-item mx-3"><a href="careers" class="active">Careers</a></li>
        ...
        <div class="careers-container">
            ...
            <form action="process.php" method="POST" class="careers-form" id="careerForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="mobile" name="mobile" maxlength="10" placeholder="Enter your number" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="pan" name="pan" maxlength="10" placeholder="Enter your PAN card number" required>
...
//                 pan: "<h6 style='color:red'>Invalid PAN card format.</h6>"
//             }
//         },
//         errorElement: "div",
...
$(document).ready(function () {
    ...
    $.validator.addMethod("mobile", function (value, element) {
        return /^[0-9]{10}$/.test(value);  // Checks if it's exactly 10 digits
    ...
    $("#careerForm").validate({
        ...
        messages: {
            ...
            mobile: {
                ...
                mobile: "<h6 style='color:red'>Invalid mobile number format.</h6>"
            }
        },
        errorElement: "div",
        errorPlacement: function (error, element) {
    ...
    // Automatically validate PAN on input or blur
    $('#pan').on('input blur', function () {
        $(this).valid(); // Trigger validation for PAN
    });

    // Automatically validate Mobile on input or blur
    $('#mobile').on('input blur', function () {
        $(this).valid(); // Trigger validation for Mobile
    });
});
</script>
