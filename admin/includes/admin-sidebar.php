      ...
      <aside class="main-sidebar hidden-print ">
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
               ...
               <!-- <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> User Details</span><i class="icon-arrow-down"></i></a> 
               
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="add-user-detail.php"><i class="icon-arrow-right"></i> Add User-Detail </a></li>
                        <li><a class="waves-effect waves-dark" href="user-view-detail"><i class="icon-arrow-right"></i> View User-Detail</a></li>
                    </ul>
                </li> -->
                <!-- <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Lead Contact</span><i class="icon-arrow-down"></i></a> 
               
               <ul class="treeview-menu">
                   <li><a class="waves-effect waves-dark" href="view-lead-no.php"><i class="icon-arrow-right"></i>Lead Contact No</a></li>
                 
               </ul>
               </li> -->


               <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Admin Register </span><i class="icon-arrow-down"></i></a> 
               
               <ul class="treeview-menu">
                   <li><a class="waves-effect waves-dark" href="admin-register-new.php"><i class="icon-arrow-right"></i>Add Admin Register</a></li>
                   <!-- <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> View Admin-Detail</a></li> -->
               </ul>
           </li>

                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span>Career Page</span><i class="icon-arrow-down"></i></a> 
               
               <ul class="treeview-menu">

                   <li><a class="waves-effect waves-dark" href="view-career-data.php"><i class="icon-arrow-right"></i> View Career Data</a></li>
               </ul>
           </li>
        
        
           <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span>Blog Details</span><i class="icon-arrow-down"></i></a> 
               
               <ul class="treeview-menu">
               <li><a class="waves-effect waves-dark" href="add-blog-data.php"><i class="icon-arrow-right"></i> Add Blog Data</a></li>
                   <li><a class="waves-effect waves-dark" href="view-blog-data.php"><i class="icon-arrow-right"></i> View Blog Data</a></li>
               </ul>
           </li>
           ...
           <!-- <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span>Stock-Market Page</span><i class="icon-arrow-down"></i></a> 
               
               <ul class="treeview-menu">
                   <li><a class="waves-effect waves-dark" href="add-stockmarket-data.php"><i class="icon-arrow-right"></i> Add Stock-Market Data </a></li>
                   <li><a class="waves-effect waves-dark" href="view-stockmarket-data.php"><i class="icon-arrow-right"></i> View Stock-Market Data</a></li>
                   
               </ul>
           </li> -->

           <!-- <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span>PMS & AIF Page</span><i class="icon-arrow-down"></i></a> 
               
               <ul class="treeview-menu">
                   <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Add PMS & AIF Data </a></li>
                   <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> View PMS & AIF Data</a></li>
               </ul>
           </li> -->
